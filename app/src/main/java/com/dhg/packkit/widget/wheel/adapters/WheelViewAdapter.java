...
public interface WheelViewAdapter {
	...
	/**
	 * Get a View that displays the dateList at the specified position in the dateList set
	 * 
	...
	/**
	 * Register an observer that is called when changes happen to the dateList used by this adapter.
